...
#ifdef CONFIG_LGE_PM
/*
 * Krait freq down to 1.0Ghz when factory boot mode.
 * Freq should be update corresponding to backlight level.
 * yk.kim@lge.com
 */
#if defined(CONFIG_MACH_APQ8064_J1KD) || defined(CONFIG_MACH_APQ8064_J1D)
static struct acpu_level acpu_freq_tbl_8064_factory_56k_slow[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   950000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   975000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   975000 },
...
static struct acpu_level acpu_freq_tbl_8064_factory_56k_nom[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   900000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   900000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   925000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   925000 },
...
static struct acpu_level acpu_freq_tbl_8064_factory_56k_fast[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   850000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   875000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   875000 },
...
static struct acpu_level acpu_freq_tbl_8064_factory_slow[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   950000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   975000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   975000 },
...
static struct acpu_level acpu_freq_tbl_8064_factory_nom[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   900000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   900000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   925000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   925000 },
...
static struct acpu_level acpu_freq_tbl_8064_factory_fast[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   850000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   875000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   875000 },
...
#if defined(CONFIG_MACH_APQ8064_J1KD) || defined(CONFIG_MACH_APQ8064_J1D)
static struct acpu_level *acpu_freq_tbl_8064_factory_56k[NUM_PVS] __initdata = {
	[PVS_SLOW] = acpu_freq_tbl_8064_factory_56k_slow,
	[PVS_NOM] = acpu_freq_tbl_8064_factory_56k_nom,
	[PVS_FAST] = acpu_freq_tbl_8064_factory_56k_fast,
	[PVS_FASTER] = acpu_freq_tbl_8064_factory_56k_fast,
};
#endif

static struct acpu_level *acpu_freq_tbl_8064_factory[NUM_PVS] __initdata = {
	[PVS_SLOW] = acpu_freq_tbl_8064_factory_slow,
	[PVS_NOM] = acpu_freq_tbl_8064_factory_nom,
	[PVS_FAST] = acpu_freq_tbl_8064_factory_fast,
	[PVS_FASTER] = acpu_freq_tbl_8064_factory_fast,
};
#endif
...
static void __init select_freq_plan(void)
{
...
#if defined(CONFIG_MACH_APQ8064_J1KD) || defined(CONFIG_MACH_APQ8064_J1D)
		if(lge_get_factory_56k_boot())
			acpu_freq_tbl = acpu_freq_tbl_8064_factory_56k[pvs_id];	
		else if (lge_get_factory_boot())
#else
		if (lge_get_factory_boot())
#endif
			acpu_freq_tbl = acpu_freq_tbl_8064_factory[pvs_id];
		else {
	...
	{
		/* Find the min supported scaling frequency. */
		for (l = acpu_freq_tbl; l->speed.khz != 0; l++)
		{
			if (l->use_for_scaling)
			{
		...
		pr_info("chargerlogo select : %u KHz\n", max_acpu_level->speed.khz);
	}
#endif
