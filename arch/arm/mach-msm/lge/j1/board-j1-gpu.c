...
#if defined(CONFIG_MACH_APQ8064_J1KD) || defined(CONFIG_MACH_APQ8064_J1D)
static struct kgsl_device_platform_data kgsl_3d0_factory_56k_pdata = {
	.pwrlevel = {
		{
			.gpu_freq = 200000000,
			.bus_freq = 2,
...
#if defined(CONFIG_MACH_APQ8064_J1KD) || defined(CONFIG_MACH_APQ8064_J1D)
struct platform_device device_kgsl_3d0_factory_56k = {
	.name = "kgsl-3d0",
	.id = 0,
	.num_resources = ARRAY_SIZE(kgsl_3d0_resources),
	.resource = kgsl_3d0_resources,
	.dev = {
		.platform_data = &kgsl_3d0_factory_56k_pdata,
	},
};
#endif
...
void __init apq8064_init_gpu(void)
{
	...
	if (lge_get_factory_56k_boot())
		platform_device_register(&device_kgsl_3d0_factory_56k);
	else
#endif
