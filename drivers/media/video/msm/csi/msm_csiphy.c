...
// Start LGE_BSP_CAMERA::seongjo.kim@lge.com Add MIPI log for debug
#define DBG_CSIPHY 1
// End LGE_BSP_CAMERA::seongjo.kim@lge.com Add MIPI log for debug
...
//LGE_UPDATE_S 0828 add messages to debug timeout error yt.jeon@lge.com
	pr_err("%s MIPI_CSIPHY%d_INTERRUPT_STATUS0 = 0x%x\n",
...
//LGE_UPDATE_S 0828 add messages to debug timeout error yt.jeon@lge.com
	pr_err("%s MIPI_CSIPHY%d_INTERRUPT_STATUS1 = 0x%x\n",
//LGE_UPDATE_E 0828 add messages to debug timeout error yt.jeon@lge.com
		__func__, csiphy_dev->pdev->id, irq);
...
//LGE_UPDATE_S 0828 add messages to debug timeout error yt.jeon@lge.com
	pr_err("%s MIPI_CSIPHY%d_INTERRUPT_STATUS2 = 0x%x\n",
//LGE_UPDATE_E 0828 add messages to debug timeout error yt.jeon@lge.com
		__func__, csiphy_dev->pdev->id, irq);
...
//LGE_UPDATE_S 0828 add messages to debug timeout error yt.jeon@lge.com
	pr_err("%s MIPI_CSIPHY%d_INTERRUPT_STATUS3 = 0x%x\n",
//LGE_UPDATE_E 0828 add messages to debug timeout error yt.jeon@lge.com
		__func__, csiphy_dev->pdev->id, irq);
...
//LGE_UPDATE_S 0828 add messages to debug timeout error yt.jeon@lge.com
	pr_err("%s MIPI_CSIPHY%d_INTERRUPT_STATUS4 = 0x%x\n",
//LGE_UPDATE_E 0828 add messages to debug timeout error yt.jeon@lge.com
		__func__, csiphy_dev->pdev->id, irq);
