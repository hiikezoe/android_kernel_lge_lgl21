...
#elif defined(CONFIG_MACH_APQ8064_J1KD)
	#define ADAPTIVE_USB_CURRENT_CHECK_PERIOD_MS 	(5000)
	#define ADAPTIVE_USB_CURRENT_DROP_CHECK_MS		(500)
	#define CHARGING_COLLAPSE_VOLTAGE				(the_chip->max_voltage_mv)
	#define CHARGING_COLLAPSE_VOLTAGE_1500MA		(4500)
	#define ADAPTIVE_NUM_OF_TABLE_TAIL				(1500)
...
#if defined(CONFIG_MACH_APQ8064_J1KD)
	int collapse_voltage = 0;
#endif
...
#if defined(CONFIG_MACH_APQ8064_J1KD)
	if(next_ma == ADAPTIVE_NUM_OF_TABLE_TAIL)
		collapse_voltage = CHARGING_COLLAPSE_VOLTAGE_1500MA;
	else
		collapse_voltage = CHARGING_COLLAPSE_VOLTAGE;
	
	if ( Vchg.physical < collapse_voltage*1000 &&
		 search_iusb_max_status != IUSB_MAX_NONE )
	{
