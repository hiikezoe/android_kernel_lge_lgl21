	...
	while (ptr < end && thread->return_error == BR_OK) {
		...
		case BC_DECREFS: {
			...
			if (target == 0 && binder_context_mgr_node &&
				...
				/*Start: WBT Fix santhosh.punugu@lge.com 17-07-2012 TD-issue:368464*/
				/*Fix Description: Function "binder_get_ref_for_node" might return NULL if it does not find an entry
						   in the RB-tree or if memory allocation fails. So, a null check would do good.*/
				...
				/*End: WBT Fix santhosh.punugu@lge.com 17-07-2012*/
			} else
...
// yongmin.jung@lge.com 2012.07.31 Enabled binder error message to get the reason of binder error
